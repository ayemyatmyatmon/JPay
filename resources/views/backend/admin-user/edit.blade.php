...
<div class="row">
    <div class="col-md-8">
        <form action="{{route('admin-user.update',$admin_user->id)}}" method="POST" id="create">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="phone_number" name="phone_number" class="form-control" value="{{$admin_user->phone_number}}">
